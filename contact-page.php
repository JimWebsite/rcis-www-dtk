									...
									<div class="contact_form">
										...
										<form id="contact-form" method="post" action="">
											...
											if($qode_options['use_recaptcha'] == "yes") :
												...
												<?php } ?>
												<p id="captchaHolder"><?php if($qode_options['page_transitions'] == "0"): echo recaptcha_get_html($publickey); endif;?></p>
												<p id="captchaStatus">&nbsp;</p>
											<?php endif; ?>
											<input type="submit" class="button small black" value="Send Message" />
										</form>
									</div>
								</div>
							</div>
