...
function three_columns($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="three_columns clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function four_columns($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="four_columns clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function two_columns($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="two_columns_50_50 clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function two_columns_66_33($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="two_columns_66_33 clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function two_columns_33_66($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="two_columns_33_66 clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function two_columns_75_25($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="two_columns_75_25 clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function two_columns_25_75($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
    return '<div class="two_columns_25_75 clearfix ' . $class . '">' . do_shortcode($content) . '</div>';
}
}
...
function column1($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
	return '<div class="column1"><div class="column_inner ' . $class . '">' . do_shortcode($content) . '</div></div>';
}
}
...
function column2($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
	return '<div class="column2"><div class="column_inner ' . $class . '">' . do_shortcode($content) . '</div></div>';
}
}
...
function column3($atts, $content = null) {
	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
   return '<div class="column3"><div class="column_inner ' . $class . '">' . do_shortcode($content) . '</div></div>';
}
}
...
function column4($atts, $content = null) {
 	extract(shortcode_atts(array(
		'class' =>'0'),$atts));
  return '<div class="column4"><div class="column_inner ' . $class . '">' . do_shortcode($content) . '</div></div>';
}
}
...
function portfolio_list($atts, $content = null) {
	$html = "";
	extract(shortcode_atts(array("columns" => "3", "number"=>"-1", "filter"=>'no', "category"=>""), $atts));
...
function slider($atts, $content = null) {
	...
	$sliders = get_post_meta(get_the_ID(), "qode_sliders", true);
	$html = "";
	...
	if($type == "small1" || $type == "small2"){
		foreach($sliders as $slider) 
		{
			...
			if($slider['unique'] == $id) 
			{
				...
				$html .= '<div class="slider_small_holder"><div class="slider_small_holder_inner"><ul';
				$number = count($slider);
				if($number > 3){
				$html .= ' class="on" ';
				}
...
function social_icons($atts, $content = null) {
    ...
    {
    $html .=  "<li class='" . trim($social_icons_array[$i]) . "'><a href='" . trim($social_icons_array[$i + 1]) . "'>" . trim($social_icons_array[$i]) . "</a></li>";   
    }
     $html .=  "           </ul>";
...
function service($atts, $content = null) {
    $html = ""; 
	extract(shortcode_atts(array("type"=>"top", "title" => "") , $atts));	
