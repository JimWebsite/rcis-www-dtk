...
class Qode_Theme_Options {
	...
	function qode_generate_options_page() {
		...
		<div id="qode-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('version %1$s', 'qode'), '1.1.3' ); ?></h2>
			...
			<div>
				<table class="form-table">
					<tbody>
						...
						<tr valign="top">
								<td scope="row" width="150"><?php esc_html_e('Dropdown menu style', 'qode'); ?></td>
								<td>
									<div class="inline">
