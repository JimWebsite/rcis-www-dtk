...
function qode_styles() {
	...
	wp_enqueue_style("flexslide_css", QODE_ROOT."/css/flexslider.css");

	wp_enqueue_style("stylesheet", QODE_ROOT."/css/stylesheet.css");

	wp_enqueue_style("theme_style", QODE_ROOT."/css/theme_style.css");
	...
	if($responsiveness != "no"):
		...
		wp_enqueue_style("responsive", QODE_ROOT."/css/responsive.css");
	...
	$fonts_array  = array(
						...
						$qode_options['google_fonts'],

						$qode_options['h1_google_fonts'],

						$qode_options['h2_google_fonts'],

						$qode_options['h3_google_fonts'],

						$qode_options['h4_google_fonts'],

						$qode_options['h5_google_fonts'],

						$qode_options['h6_google_fonts'],

						$qode_options['h6_google_fonts'],

						$qode_options['text_google_fonts'],

						$qode_options['page_title_google_fonts'],

						$qode_options['slider_title_google_fonts'],

						$qode_options['slider_text_google_fonts'],

						$qode_options['button_title_google_fonts'],

						$qode_options['message_title_google_fonts'],

						$qode_options['smallslider_title_google_fonts'],

						$qode_options['smallslider_text_google_fonts'],

						$qode_options['slider_title_google_fonts_type2'],

						$qode_options['portfolio_list_title_google_fonts'],

						$qode_options['portfolio_list_text_google_fonts'],

						$qode_options['smallslider_title_google_fonts_type2'],

						$qode_options['smallslider_text_google_fonts_type2'],

						$qode_options['dropdown_google_fonts']
	...
	if(count($fonts_array) > 0) :
		...
		printf("<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,200,200italic,300,600,700,300italic,400italic,600italic,700italic|PT+Sans:400,400italic,700,700italic|%s' type='text/css' />\r\n", str_replace(' ', '+', $google_fonts_string));

	else :

		printf("<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,200,200italic,300,600,700,300italic,400italic,600italic,700italic|PT+Sans:400,400italic,700,700italic' type='text/css' />\r\n");
...
function qode_scripts() {
	...
	wp_enqueue_script("flex", QODE_ROOT."/js/jquery.flexslider-min.js",array(),false,true);

	wp_enqueue_script("easing", QODE_ROOT."/js/jquery.easing.1.3.js",array(),false,true);

	wp_enqueue_script("hover", QODE_ROOT."/js/jquery.hoverIntent.min.js",array(),false,true);

	wp_enqueue_script("jcarousel", QODE_ROOT."/js/jquery.bxslider.min.js",array(),false,true);

	wp_enqueue_script("jquery-ui", QODE_ROOT."/js/jquery-ui-1.9.2.custom.min.js",array(),false,true);

	wp_enqueue_script("appear", QODE_ROOT."/js/jquery.appear.js",array(),false,true);
	...
	wp_enqueue_script("stylish-select", QODE_ROOT."/js/jquery.stylish-select.min.js",array(),false,true);

	wp_enqueue_script("fitvids", QODE_ROOT."/js/jquery.fitvids.js",array(),false,true);
	...
	if ($has_ajax) :
		...
		wp_enqueue_script("form", QODE_ROOT."/js/jquery.form.js",array(),false,true);

		wp_enqueue_script("wait", QODE_ROOT."/js/jquery.waitforimages.js",array(),false,true);

		wp_enqueue_script("ajax", QODE_ROOT."/js/ajax.js",array(),false,true);
...
add_image_size( 'single-type-1-small', 220, 220, false );
