										...
										<article <?php post_class(); ?>>
											...
											<div class="text">
												<div class="text_inner">
													...
													<h2><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?>JAA</a></h2>													<p>JAA index 1</p>
													<p><?php the_excerpt(); ?></p>
									...
									<div class="posts_holder2">
										<?php if(have_posts()) : while ( have_posts() ) : the_post(); ?>
											<article <?php post_class(); ?>>
												...
												<span class="right"><a href="<?php //comments_link(); ?>"><?php comments_number( 'no comments', 'one comment', '% comments' ); ?></a> / <a href="<?php the_permalink(); ?>" class="more" title="<?php the_title_attribute(); ?>"><?php _e('READ MORE', 'qode'); ?></a></span>
												</div>
											</article>
										<?php endwhile; ?>
										<?php if($qode_options['pagination'] != "0") : ?>
										...
										<article <?php post_class(); ?>>
											...
											<div class="text">
												<div class="text_inner">
													...
													<h2><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?>JAA Index 2</a></h2>													<p>JAA index 2</p>
													<p><?php the_excerpt(); ?></p>
													<a href="<?php the_permalink(); ?>" class="more" title="<?php the_title_attribute(); ?>"><?php _e('READ MORE', 'qode'); ?></a>
													<div class="info">
														<span class="left"><?php the_time('d M Y'); ?> <?php _e('Posted by','qode'); ?> <?php the_author(); ?> <?php _e('in','qode'); ?> <?php the_category(', '); ?></span>
